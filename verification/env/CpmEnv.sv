...
class CpmEnv extends uvm_env;
    ...
    virtual function void connect_phase(uvm_phase phase);
        ...
        // Connect register monitor mode changes to scoreboard
        // This allows scoreboard to track current mode without packet monitor accessing RAL
        m_reg_agent.m_monitor.m_ap_mode.connect(m_scoreboard.m_export_mode.analysis_export);
