...
│   ├── pkg/                 # Packages (per-component)
│   ├── interfaces/          # SystemVerilog interfaces
│   ├── transactions/        # UVM transactions
│   ├── config/              # Configuration objects
│   ├── agent/               # UVM agents
│   │   ├── packet/          # Packet agent, driver, monitor, sequencer
│   │   └── reg/             # Register agent, driver, monitor, sequencer
│   ├── env/                 # UVM environment
│   ├── scoreboard/          # Scoreboard, ref model & mode imp
│   ├── coverage/            # Coverage collectors
│   ├── callbacks/           # Callback classes (virtual base)
...
1. Review simulation logs in `logs/` directory
2. Check QuestaSim transcript file
3. See [USER_GUIDE.md](../deliverables/USER_GUIDE.md) in deliverables for detailed guidance
